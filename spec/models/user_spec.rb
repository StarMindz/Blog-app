  ...
  context 'Custom methods' do
    it 'returns recent posts' do
      user01 = User.create(name: 'Tom', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.',
                           post_counter: 0)
      7.times do
        Post.create(author_id: user01, title: 'Hello', text: 'This is my first post', likes_counter: 0,
                    comments_counter: 0)
      end
      expect(user01.most_recent_post).to match_array(user01.posts.last(3))
    end
  end
end
